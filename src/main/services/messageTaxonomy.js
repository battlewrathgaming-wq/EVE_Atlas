...
const DEFINITIONS = Object.freeze({
  ...
  ASSESSMENT_PRESERVATION_RECOMMENDED: definition(SEVERITIES.WARNING, CATEGORIES.EVIDENCE, true),
  ...
  DESTRUCTIVE_CONFIRMATION_REQUIRED: definition(SEVERITIES.BLOCKED, CATEGORIES.USER_ACTION, true),
  HTTP_CANCELLED: definition(SEVERITIES.WARNING, CATEGORIES.API, true),
  HTTP_TIMEOUT: definition(SEVERITIES.WARNING, CATEGORIES.API, true),
