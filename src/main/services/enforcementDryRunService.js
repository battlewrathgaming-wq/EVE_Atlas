...
const COMMAND_ENFORCEMENT_COVERAGE = Object.freeze({
  ...
  'metadata.selected_id_readability_repair.product_preflight': coverage('hydration_readability_repair', 'none', 'selected_id_product_readability_repair_preflight_readout', 'covered_read_only', 'Previews product selected-ID readability repair authority without provider calls, writes, execution, queues, enforcement, or UI work.'),
  'metadata.selected_id_resolve_candidate.preview': coverage('hydration_readability_repair', 'none', 'selected_id_resolve_candidate_report_handoff_readout', 'covered_read_only', 'Previews local report-visible selected-ID Resolve candidates without provider calls, writes, execution, queues, enforcement, or UI work.'),
  'metadata.selected_id_readability_repair.execute': coverage('hydration_readability_repair', 'esi_provider_required', 'trusted_selected_id_readability_repair_execute', 'covered_provider_and_storage_gated', 'Trusted non-renderer Resolve execution can call ESI /universe/names for one selected unresolved local ID and write readability repair only.'),
  ...
  'runtime.watch_task_outcome_map.preview': coverage('local_db_inspection', 'none', 'watch_task_outcome_map_readout', 'read_only_non_enforcing_proof', 'Read-only Watch/task origin and durable outcome map preview; no providers, Watch dispatch, task creation, writes, schema, watch_result, relationship tags, enforcement, or UI.'),
  'watch.scope_authority_conformance.preview': coverage('local_db_inspection', 'none', 'watch_scope_authority_conformance_readout', 'read_only_non_enforcing_proof', 'Read-only Watch scope authority conformance preview; no providers, Watch dispatch, task creation, writes, schema, execution correction, enforcement, or UI.'),
  'watch.authored_execution_readiness.preview': coverage('local_db_inspection', 'none', 'authored_watch_execution_readiness_readout', 'read_only_non_enforcing_proof', 'Read-only authored Watch execution readiness preview; derives future execution input from stored included_system_ids without dispatch, providers, tasks, writes, schema, enforcement, or UI.'),
  'watch.system_radius_setup_readout.preview': coverage('local_db_inspection', 'none', 'system_radius_watch_setup_readout', 'read_only_non_enforcing_proof', 'Read-only post-create system/radius Watch setup readout; inspects stored included_system_ids without dispatch, providers, tasks, writes, schema, enforcement, or UI.'),
  'watch.system_radius_readout_readiness_bridge.preview': coverage('local_db_inspection', 'none', 'system_radius_readout_readiness_bridge', 'read_only_non_enforcing_proof', 'Read-only bridge between setup readout and authored execution readiness; compares stored included_system_ids without dispatch, providers, tasks, writes, schema, enforcement, or UI.'),
  'watch.runtime_packet_plan.preview': coverage('local_db_inspection', 'none', 'watch_runtime_packet_plan_readout', 'read_only_non_enforcing_proof', 'Read-only Watch runtime packet plan preview; shapes accepted Watch scope into future packet plans without dispatch, providers, tasks, writes, schema, enforcement, or UI.'),
  'watch.executor_tick_dry_run.preview': coverage('local_db_inspection', 'none', 'watch_executor_tick_dry_run_readout', 'read_only_non_enforcing_proof', 'Read-only Watch executor tick dry-run preview; reports next tick decision without calling tick, dispatching Watch work, creating tasks, providers, writes, schema, enforcement, or UI.'),
  'watch.packet_dry_run_dispatch_parity.preview': coverage('local_db_inspection', 'none', 'watch_packet_dry_run_dispatch_parity_readout', 'read_only_non_enforcing_proof', 'Read-only Watch packet/dry-run/dispatch parity proof; compares future movement shape without tick, task creation, runner invocation, providers, writes, schema, enforcement, or UI.'),
  'watch.task_creation_boundary.preview': coverage('local_db_inspection', 'none', 'watch_task_creation_boundary_readout', 'read_only_non_enforcing_proof', 'Read-only Watch task-creation boundary proof; describes would-task envelope without TaskRunner method calls, task creation, execution, providers, writes, schema, enforcement, or UI.'),
  'watch.system_radius_run_stub.preview': coverage('local_db_inspection', 'none', 'watch_system_radius_run_stub_readout', 'read_only_non_enforcing_proof', 'Read-only system/radius Watch-run stub projection; emits one candidate stub from accepted stored scope without buckets, pickup, providers, writes, schema, enforcement, or UI.'),
  'watch.bucket_identity_projection.preview': coverage('local_db_inspection', 'none', 'watch_bucket_identity_projection_readout', 'read_only_non_enforcing_proof', 'Read-only fixture Watch bucket identity projection; reports projected candidates, suppressions, overlaps, and conflicts without schema, buckets, pickup, providers, writes, enforcement, or UI.'),
  'watch.bucket_pickup_posture_bridge.preview': coverage('local_db_inspection', 'none', 'watch_bucket_pickup_posture_bridge_readout', 'read_only_non_enforcing_proof', 'Read-only fixture Watch bucket candidate pickup posture bridge; reports future pickup eligibility or External I/O hold without bucket persistence, pickup, providers, writes, enforcement, or UI.'),
  'watch.bucket_disposable_persistence_fixture.preview': coverage('local_db_inspection', 'none', 'watch_bucket_disposable_persistence_fixture_readout', 'read_only_non_enforcing_proof', 'Fixture-only disposable Watch bucket persistence semantics proof; uses isolated in-memory state without product schema, operator corpus mutation, pickup, providers, writes, enforcement, or UI.'),
  'watch.bucket_product_persistence.emit': coverage('setup_config_changes', 'none', 'watch_bucket_product_persistence', 'covered_local_mutation', 'Trusted local system/radius Watch bucket persistence; writes only watch_bucket_items and does not start Discovery pickup, providers, refs, Evidence/EVEidence, cadence mutation, enforcement, or UI.'),
  'watch.bucket_product_pickup_readout.preview': coverage('local_db_inspection', 'none', 'watch_bucket_product_pickup_readout', 'read_only_non_enforcing_proof', 'Read-only product watch_bucket_items pickup posture readout; does not start Discovery pickup, providers, refs, Evidence/EVEidence, cadence mutation, receipt mutation, enforcement, or UI.'),
  'watch.discovery_pickup_packet_proof.preview': coverage('local_db_inspection', 'none', 'watch_discovery_pickup_packet_readout', 'read_only_non_enforcing_proof', 'Read-only Watch Discovery pickup packet proof; emits acquisition intent packets from one due Watch without execution, task creation, providers, collectors, writes, schema, enforcement, or UI.'),
  'discovery.pickup_consumer_fixture.preview': coverage('local_db_inspection', 'none', 'discovery_pickup_consumer_fixture_readout', 'read_only_non_enforcing_proof', 'Read-only Discovery pickup consumer fixture proof; emits provider-return-like fixture candidates from pickup packets without providers, durable refs, Evidence/EVEidence, writes, schema, enforcement, or UI.'),
  'discovery.pickup_consumer_hold_contract.preview': coverage('local_db_inspection', 'none', 'discovery_pickup_consumer_hold_contract_readout', 'read_only_non_enforcing_proof', 'Fixture-only Discovery pickup consumer hold contract proof; classifies disposable open bucket rows as future pickup eligible or held by External I/O without pickup, leases, providers, refs, writes, enforcement, or UI.'),
  'discovery.pickup_selection_contract.preview': coverage('local_db_inspection', 'none', 'discovery_pickup_selection_contract_readout', 'read_only_non_enforcing_proof', 'Read-only Discovery pickup selection contract over eligible product Watch bucket readout rows; does not start pickup, leases, providers, refs, Evidence/EVEidence, cadence mutation, receipt mutation, enforcement, or UI.'),
  'discovery.provider_route_packet.preview': coverage('local_db_inspection', 'none', 'discovery_provider_route_packet_preview_readout', 'read_only_non_enforcing_proof', 'Read-only inert zKill provider-route packet preview from selected Discovery pickup candidates; does not start pickup, dispatch, providers, refs, Evidence/EVEidence, cadence mutation, receipt mutation, enforcement, or UI.'),
  'discovery.pickup_execution_boundary.preview': coverage('local_db_inspection', 'none', 'discovery_pickup_execution_boundary_preview_readout', 'read_only_non_enforcing_proof', 'Read-only pre-provider Discovery pickup execution boundary preview from inert route packets; does not start pickup, dispatch, leases, providers, refs, Evidence/EVEidence, cadence mutation, receipt mutation, enforcement, or UI.'),
  'discovery.dispatcher_lease_boundary.preview': coverage('local_db_inspection', 'none', 'discovery_dispatcher_lease_boundary_preview_readout', 'read_only_non_enforcing_proof', 'Read-only Discovery dispatcher/lease boundary preview from pickup execution boundary packets; does not start dispatcher runtime, queues, leases, claims, providers, refs, Evidence/EVEidence, cadence mutation, receipt mutation, enforcement, or UI.'),
  'discovery.candidate_ref_landing_boundary.preview': coverage('local_db_inspection', 'none', 'discovery_candidate_ref_landing_boundary_preview_readout', 'read_only_non_enforcing_proof', 'Read-only Discovery candidate-ref landing boundary preview from lease candidates and fixture provider results; does not call providers, write refs, create Evidence/EVEidence, mutate Watch, enforce, or change UI.'),
  'discovery.settled_receipt_boundary.preview': coverage('local_db_inspection', 'none', 'discovery_settled_receipt_boundary_preview_readout', 'read_only_non_enforcing_proof', 'Read-only Discovery settled receipt boundary preview from candidate-ref landing posture; projects bounded factual caller receipts without providers, writes, Watch cadence decisions, enforcement, or UI.'),
  'discovery.outcome_derivation.preview': coverage('local_db_inspection', 'none', 'discovery_outcome_derivation_readout', 'read_only_non_enforcing_proof', 'Read-only Discovery outcome derivation proof; derives coarse outcome posture from existing rows without providers, Discovery ref writes, Evidence/EVEidence, Hydration, task schema, Watch mutation, enforcement, or UI.'),
  'discovery.receipt_projection_fixture.preview': coverage('local_db_inspection', 'none', 'discovery_receipt_projection_fixture_readout', 'read_only_non_enforcing_proof', 'Read-only Discovery receipt projection fixture proof; emits non-durable receipt basis and safe projection without providers, Discovery ref writes, Evidence/EVEidence, Hydration, task schema, Watch mutation, enforcement, or UI.'),
  'watch.discovery_acquisition_split_fixture.preview': coverage('local_db_inspection', 'none', 'watch_discovery_acquisition_split_fixture_readout', 'read_only_non_enforcing_proof', 'Read-only Watch-to-Discovery acquisition split fixture bridge; proves dispatch payloads can feed Discovery acquisition without mixed collectors, providers, writes, task schema, Watch mutation, enforcement, or UI.'),
  'discovery.acquisition_to_evidence_handoff_fixture.preview': coverage('local_db_inspection', 'none', 'discovery_acquisition_to_evidence_handoff_fixture_readout', 'read_only_non_enforcing_proof', 'Read-only Discovery acquisition-to-Evidence handoff fixture proof; normalizes fixture candidate refs and emits ESI Evidence Expansion handoff shapes without providers, writes, schema, collectors, enforcement, or UI.'),
  'discovery.esi_expansion_intake_posture.preview': coverage('local_db_inspection', 'none', 'discovery_esi_expansion_intake_posture_readout', 'read_only_non_enforcing_proof', 'Read-only Discovery ESI-backed expansion intake posture proof; classifies fixture candidate refs without ESI calls, Evidence/EVEidence writes, Hydration writes, runtime replacement, collectors, enforcement, or UI.'),
  'evidence.writer_landing_package_fixture.preview': coverage('esi_evidence_expansion', 'none', 'fixture_evidence_writer_landing_package_proof', 'fixture_only_non_production', 'Fixture-only Evidence/EVEidence writer landing package proof using an internal disposable DB; no providers, operator corpus mutation, Discovery refs, Watch cadence, Hydration, Observation, Assessment, runtime replacement, enforcement, or UI.'),
  'watch.mixed_collector_replacement_route.preview': coverage('local_db_inspection', 'none', 'mixed_watch_collector_replacement_route_readout', 'read_only_non_enforcing_proof', 'Read-only mixed Watch collector replacement route preview; maps current Watch payload shapes to future boundary-owned stages without providers, writes, collector invocation, redirect, retirement, enforcement, or UI.'),
  'watch.actor_replacement_parity.preview': coverage('local_db_inspection', 'none', 'actor_watch_replacement_parity_readout', 'read_only_non_enforcing_proof', 'Read-only actor Watch replacement parity proof; maps actor Watch behavior to future boundary-owned stages without providers, writes, collector invocation, redirect, retirement, enforcement, system/radius changes, or UI.'),
  'watch.actor_compatibility_wrapper_contract.preview': coverage('local_db_inspection', 'none', 'actor_watch_compatibility_wrapper_contract_readout', 'read_only_non_enforcing_proof', 'Read-only actor.watch compatibility wrapper contract proof; composes fixture proof surfaces without redirect, collector invocation, providers, writes, runtime replacement, system/radius changes, enforcement, or UI.'),
  'watch.actor_compatibility_wrapper_adapter_fixture.preview': coverage('local_db_inspection', 'none', 'actor_watch_compatibility_wrapper_adapter_fixture_readout', 'read_only_non_enforcing_proof', 'Read-only actor.watch compatibility wrapper adapter fixture proof; constructs old caller-facing fixture result shape without redirect, runtime changes, collectors, providers, writes, system/radius changes, enforcement, or UI.'),
  'watch.actor_compatibility_wrapper.preview': coverage('local_db_inspection', 'none', 'actor_watch_compatibility_wrapper_runtime_preview', 'read_only_non_enforcing_proof', 'Read-only explicit actor.watch compatibility wrapper preview command; consumes old actor Watch payload shape and returns compatibility result posture without redirect, runtime changes, collectors, providers, writes, system/radius changes, enforcement, or UI.'),
  'watch.actor_discovery_route_body_fixture.preview': coverage('local_db_inspection', 'none', 'actor_watch_discovery_route_body_fixture_readout', 'read_only_non_enforcing_proof', 'Read-only actor Watch Discovery-owned route body fixture proof; composes Discovery helpers with fake clients only and old compatibility output without redirect, collectors, providers, writes, system/radius changes, enforcement, or UI.'),
  'watch.actor_controlled_runtime_adapter_fixture.preview': coverage('fixture_disposable_db_mutation', 'none', 'actor_watch_controlled_runtime_adapter_fixture_proof', 'fixture_only_non_production', 'Fixture-only actor Watch controlled runtime adapter proof; mutates internal disposable DBs with fake clients to prove repository choreography without redirect, collectors, providers, operator writes, system/radius changes, enforcement, or UI.'),
  'watch.actor_controlled_adapter_disabled.preview': coverage('fixture_disposable_db_mutation', 'none', 'actor_watch_controlled_adapter_disabled_proof', 'fixture_only_non_production', 'Disabled/proof-only actor Watch controlled adapter seam; projects fixture-only disposable DB proof output near service surfaces without production redirect, scheduled redirect, collectors, providers, operator writes, system/radius changes, enforcement, or UI.'),
  'watch.actor_discovery_handoff_contract.preview': coverage('local_db_inspection', 'none', 'actor_watch_discovery_handoff_contract_readout', 'read_only_non_enforcing_proof', 'Read-only actor Watch / Discovery request and receipt projection proof; no runtime movement, providers, writes, schema, enforcement, or UI.'),
  'watch.operator_confirmation_contract.preview': coverage('local_db_inspection', 'none', 'watch_operator_confirmation_contract_readout', 'read_only_non_enforcing_proof', 'Read-only Watch operator confirmation/listen-hook contract preview; no renderer UI, Watch writes, dispatch, providers, tasks, schema, enforcement, or command blocking.'),
  'watch.system_radius_authoring_preflight.preview': coverage('local_db_inspection', 'none', 'system_radius_authoring_preflight_readout', 'read_only_non_enforcing_proof', 'Read-only local system/radius Watch authoring preflight; no providers, Watch row writes, dispatch, tasks, schema, enforcement, or UI.'),
  'watch.system_radius_acceptance_payload.preview': coverage('local_db_inspection', 'none', 'system_radius_acceptance_payload_readout', 'read_only_non_enforcing_proof', 'Read-only system/radius Watch authoring acceptance payload preview; no providers, Watch row writes, dispatch, tasks, schema, enforcement, or UI.'),
  'watch.create_mutation_safety_map.preview': coverage('local_db_inspection', 'none', 'watch_create_mutation_safety_map_readout', 'read_only_non_enforcing_proof', 'Read-only watch.create mutation safety map and term-drift assurance; no providers, Watch row writes, dispatch, tasks, schema, enforcement, or UI.'),
