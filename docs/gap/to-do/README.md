...
1. `scope-controls-ui.md`
2. `queue-and-watch-status-views.md`
3. `session-armed-watch-executor-contract.md`
4. `retention-assessment-compaction-design.md`
