...
Status: HS403 accepted; awaiting next-seam decision
...
Current focus: resting after Discovery-owned zKill candidate acquisition helper extraction; next seam should stay on Discovery helper ownership before any default `actor.watch` redirect, scheduled Watch redirect, collector retirement, live/provider movement, dispatcher work, or schema work.
...
- active lane model: Discovery services provider-facing acquisition through zKill candidate-lead acquisition and ESI-backed killmail/detail expansion lanes; Evidence/EVEidence is final landed memory; Hydration outputs readability repair; fourth lane stays parked
...
- accepted by `workspace/OverseerHS352-hs351-discovery-boundary-audit-review.md`
- discovery outcome shaping captured in `workspace/OverseerHS353-discovery-outcome-model-shaping-note.md`
- `workspace/EngineeringAuditHS354-discovery-outcome-derivation-feasibility.md`
- accepted by `workspace/OverseerHS355-hs354-discovery-outcome-derivation-review.md`
- HS356 proof accepted by `workspace/OverseerHS357-hs356-discovery-outcome-derivation-review.md`
- Discovery receipt shaping accepted by `workspace/OverseerHS358-discovery-receipt-model-shaping-note.md`
- Discovery receipt source trace accepted by `workspace/OverseerHS360-hs359-discovery-receipt-source-trace-review.md`
- Discovery receipt data model accepted by `workspace/OverseerHS362-hs361-discovery-receipt-data-model-review.md`
- Discovery receipt projection fixture proof accepted by `workspace/OverseerHS364-hs363-discovery-receipt-projection-fixture-review.md`
- Discovery next-seam decision surface recorded in `workspace/OverseerHS365-discovery-next-seam-decision-surface.md`
- Discovery utility / Watch split readiness accepted by `workspace/OverseerHS367-hs366-discovery-watch-split-readiness-review.md`
- Watch-to-Discovery acquisition split fixture bridge accepted by `workspace/OverseerHS369-hs368-watch-discovery-split-fixture-review.md`
- Discovery acquisition-to-Evidence-handoff fixture runway opened in `workspace/OverseerHS370-discovery-acquisition-to-evidence-handoff-fixture-runway.md`
- Discovery acquisition-to-Evidence-handoff fixture proof accepted by `workspace/OverseerHS371-hs370-discovery-acquisition-to-evidence-handoff-review.md`
- Mixed Watch collector replacement planning request opened in `workspace/OverseerHS372-mixed-watch-collector-replacement-planning-request.md`
- Mixed Watch collector replacement plan accepted by `workspace/OverseerHS373-hs372-mixed-collector-replacement-plan-review.md`
- Mixed collector replacement route preview opened in `workspace/OverseerHS374-mixed-collector-replacement-route-preview-runway.md`
- Mixed collector replacement route preview accepted by `workspace/OverseerHS375-hs374-mixed-collector-replacement-route-review.md`
- Actor Watch first replacement slice readiness advisory accepted for Dev shaping from `workspace/EngineeringTraceHS376-actor-watch-first-replacement-slice-readiness.md`
- Actor Watch replacement parity proof opened in `workspace/OverseerHS377-actor-watch-replacement-parity-proof-runway.md`
- Actor Watch replacement parity proof accepted by `workspace/OverseerHS378-hs377-actor-watch-replacement-parity-review.md`
- Discovery ESI-backed expansion intake posture proof accepted by `workspace/OverseerHS380-hs379-discovery-esi-expansion-intake-posture-review.md`
- Actor Watch compatibility-wrapper contract proof accepted by `workspace/OverseerHS382-hs381-actor-watch-compatibility-wrapper-contract-review.md`
- Actor Watch compatibility-wrapper adapter fixture opened in `workspace/OverseerHS383-actor-watch-compatibility-wrapper-adapter-fixture-runway.md`
- Actor Watch compatibility-wrapper adapter fixture accepted by `workspace/OverseerHS384-hs383-actor-watch-compatibility-wrapper-adapter-fixture-review.md`
- Evidence/EVEidence writer landing package source trace opened in `workspace/OverseerHS385-evidence-writer-landing-package-source-trace-request.md`
- Evidence/EVEidence writer landing package source trace accepted by `workspace/OverseerHS386-hs385-evidence-writer-landing-source-trace-review.md`
- Evidence/EVEidence writer landing package fixture proof opened in `workspace/OverseerHS387-evidence-writer-landing-package-fixture-proof-runway.md`
- Evidence/EVEidence writer landing package fixture proof accepted by `workspace/OverseerHS388-hs387-evidence-writer-landing-package-fixture-review.md`
- Evidence/EVEidence writer conflict dependent-row hardening opened in `workspace/OverseerHS389-evidence-writer-conflict-dependent-row-hardening-runway.md`
- Evidence/EVEidence writer conflict dependent-row hardening accepted by `workspace/OverseerHS390-hs389-evidence-writer-conflict-hardening-review.md`
- Evidence/EVEidence writer mixed clean/conflict package proof opened in `workspace/OverseerHS391-evidence-writer-mixed-conflict-package-proof-runway.md`
- Evidence/EVEidence writer mixed clean/conflict package proof accepted by `workspace/OverseerHS392-hs391-evidence-writer-mixed-conflict-review.md`
- actor Watch runtime redirect readiness source trace opened in `workspace/OverseerHS393-actor-watch-runtime-redirect-readiness-request.md`
- actor Watch runtime redirect readiness source trace accepted by `workspace/OverseerHS394-hs393-actor-watch-redirect-readiness-review.md`
- actor Watch compatibility-wrapper command runway opened in `workspace/OverseerHS395-actor-watch-compatibility-wrapper-command-runway.md`
- actor Watch compatibility-wrapper command accepted by `workspace/OverseerHS396-hs395-actor-watch-compatibility-wrapper-command-review.md`
- Discovery helper ownership source trace opened in `workspace/OverseerHS397-discovery-helper-ownership-source-trace-request.md`
- Discovery helper ownership source trace accepted by `workspace/OverseerHS398-hs397-discovery-helper-ownership-source-trace-review.md`
- Discovery expansion queue helper extraction opened in `workspace/OverseerHS399-discovery-expansion-queue-helper-extraction-runway.md`
- Discovery expansion queue helper extraction accepted by `workspace/OverseerHS400-hs399-discovery-expansion-queue-helper-extraction-review.md`
- zKill acquisition helper ownership source trace accepted by `workspace/OverseerHS402-hs401-zkill-acquisition-helper-ownership-review.md`
- Discovery zKill candidate acquisition helper extraction opened in `workspace/OverseerHS403-discovery-zkill-candidate-acquisition-helper-extraction-runway.md`
- Discovery zKill candidate acquisition helper extraction accepted by `workspace/OverseerHS404-hs403-discovery-zkill-candidate-acquisition-helper-extraction-review.md`

Accepted HS351 / HS352 clarification:

- current docs and HS347/HS349 proof surfaces align with the emerging Discovery boundary
- current live-capable Watch collectors still mix Discovery acquisition, Discovery ref persistence, ESI Evidence Expansion, Evidence writes, warnings/logs, fetch-run lifecycle, and Watch run posture
- Watch completion should be a Discovery-task outcome, not Evidence/EVEidence, Hydration, Observation, or Assessment completion
- invalid scope belongs before Discovery acceptance at Intent / Scope Authority
- system/radius Watch acquisition completion requires every emitted Discovery packet for the accepted scope/window to reach a declared Discovery outcome
- coarse outcomes are partially derivable today, but per-packet system/radius outcomes are not reliably derivable from current rows
- future `discovery_task` / `discovery_task_packet` or equivalent read model is likely later, but not authorized now

First Discovery outcome words for shaping:
...
Latest accepted implementation activity:

```txt
HS395 added an explicit read-only/no-provider `watch.actor_compatibility_wrapper.preview` command that accepts the old actor Watch payload shape, returns old caller-facing compatibility posture through accepted fixture surfaces, and proves current `actor.watch -> runActorWatchService -> collectActorWatch` plus scheduled actor dispatch remain unchanged.
```

Settled HS353 shaping:

- Manual path adoption is parked while Discovery language is defined from the shared utility perspective.
- `acquisition_capped` is accepted as a complete-but-limited Discovery outcome: Watch may rest/continue cadence, but Atlas must not imply full coverage.
- zKill bounded/FIFO behavior is the grounding example for capped acquisition.
- Observation remains later; current focus is whether Discovery can complete its acquisition loop and return a bounded receipt to source intent.

Accepted HS354 / HS355 finding:

- current rows can derive useful coarse Discovery outcome posture
- product-grade per-packet Discovery outcomes for live system/radius Watch completion are not safely derivable today
- `discovered_killmail_refs` should remain candidate-ref memory, not Discovery task/packet memory
- HS356 accepted a read-only Discovery outcome derivation proof with confidence and missing-basis flags
...
Accepted HS358 Discovery receipt shaping:

- Discovery owns receipt language because Watch is only one caller.
- Discovery should over-report factual basis and under-claim authority.
- Discovery reports facts and limits; it does not report caller satisfaction.
- Callers decide meaning from receipt fields:
  - Watch can decide rest/retry/cadence/gap posture.
  - Manual can show an immediate acquisition result later.
  - Future recovery can select deferred/failed packets.
  - Observation can disclose basis without treating Discovery refs as Evidence.
- Next useful assurance is a source-trace pass before Dev implements receipt machinery or schema.

Accepted HS359 / HS360 source trace:

- Atlas can emit receipt-like facts today, but not a product-grade per-packet Discovery receipt.
- `discovery.outcome_derivation.preview` is the strongest read-only derived posture.
- `watch.discovery_pickup_packet_proof.preview` is the strongest pre-provider packet basis.
- `discovery.pickup_consumer_fixture.preview` is the strongest fixture candidate bridge.
- Current write-capable Watch collectors still mix Watch, Discovery, ESI Evidence Expansion, Evidence writes, warnings/logs, and Watch run posture.
- Recommended path is staged hybrid:
  1. keep HS356 derived/read-only posture for audit/readout
  2. prove a non-durable fixture Discovery receipt shape next
  3. defer durable Discovery task/packet schema until the receipt lifecycle proves itself

Accepted HS361 / HS362 data model:

- Discovery owns the canonical receipt basis.
- Callers may request safe projections of that basis.
- Projection is performance/presentation shaping only, not meaning ownership.
- `held_by_external_io` is request-level pre-acquisition posture, not packet outcome for the next proof.
- Attempted acquisition packets use packet outcome vocabulary; top-level receipt rolls up packet outcomes through counts and posture fields.
- No separate task-outcome truth vocabulary is needed now.
- Next proof should be fixture-only and non-durable; schema remains parked.
...
```txt
Mapvault audit prompt for HS401 zKill acquisition helper ownership
```
...
No `actor.watch` redirect, `system.radius.watch` redirect, `runActorWatchService(...)` change, `watchExecutor.dispatchFor(...)` change, collector invocation/rewrite/retirement, provider-call behavior change, `ZKillDiscoveryClient.discoverRefs(...)` change, `HttpClient` construction/API logging policy change, Discovery ref write behavior change, candidate-ref status behavior change, Evidence/EVEidence write behavior change, Hydration/metadata write, `fetch_runs` / warnings / Watch cadence behavior change, schema, Discovery task/packet persistence, dispatcher/queue/lease/worker behavior, command metadata/authority change, runtime enforcement, command blocking, UI, support artifact, source-term rename, or protected-word JSON update.

## HS403 Evidence

Implemented the Discovery-owned zKill candidate acquisition helper extraction.
...
- `discoverActorRefs(...)`
- actor zKill candidate normalization
- `discoverSystemRefs(...)`
- system zKill candidate normalization
...
```txt
src/main/discovery/zkillCandidateAcquisition.js now defines and exports:
  discoverActorRefs
  discoverSystemRefs

src/main/workers/actorWatchCollector.js imports discoverActorRefs from:
  ../discovery/zkillCandidateAcquisition

src/main/workers/systemRadiusCollector.js imports discoverSystemRefs from:
  ../discovery/zkillCandidateAcquisition

src/main/workers/manualDiscoveryWorker.js imports discoverActorRefs and discoverSystemRefs from:
  ../discovery/zkillCandidateAcquisition
```
...
```txt
src/main/workers/systemRadiusCollector.js keeps the old discoverRefs export as a thin compatibility alias:
  discoverRefs: discoverSystemRefs

src/main/workers/actorWatchCollector.js keeps discoverActorRefs exported from the collector boundary as a thin imported surface.
```
...
- helper definitions live in `src/main/discovery/zkillCandidateAcquisition.js`
- manual discovery no longer imports zKill acquisition helpers from Watch collector modules
- system collector keeps only the compatibility `discoverRefs: discoverSystemRefs` alias
- provider-call primitive remains `zkillClient.discoverRefs(...)`; `ZKillDiscoveryClient.discoverRefs(...)` was not changed
...
- `npm.cmd run verify:protected-terms` completed with warning-only advisory output: 1250 warnings across the current broad working set; no source-term rename or protected-word JSON update was performed
- `git diff --check` returned exit code 0 with CRLF normalization warnings only
- `git status --short --branch` showed branch `main...origin/main [ahead 19]` with the existing broad unaccepted working set plus HS403-touched files
...
- no Discovery ref write/status behavior change
- no Evidence/EVEidence write behavior change
- no Hydration/metadata write
- no `fetch_runs`, API logs, warnings, Watch cadence, or Watch run record behavior change
- no schema, Discovery task/packet persistence, dispatcher/queue/lease/worker behavior, command metadata/authority change, runtime enforcement, command blocking, UI, support artifact, source-term rename, or protected-word JSON update
...
Status: Discovery zKill candidate acquisition helper extraction complete and accepted by Overseer.

Overseer reviewed 2026-06-07:

- Accepted HS403 in `workspace/OverseerHS404-hs403-discovery-zkill-candidate-acquisition-helper-extraction-review.md`.
- Confirmed zKill candidate acquisition helper definitions now live under Discovery ownership.
- Confirmed manual discovery imports zKill acquisition helpers from Discovery rather than Watch collector modules.
- Confirmed actor/system collector compatibility exports are aliases/imported surfaces only.
- Confirmed provider path and write behavior remain unchanged.
- Verified focused syntax, actor Watch, system collector, manual discovery, recent Discovery/Evidence fixture guardrails, registry/authority/passive/enforcement guardrails, protected-term advisory output, and diff hygiene.
- Repo remains noisy with the broad uncommitted/untracked milestone stack; HS403 did not introduce runtime redirect or collector retirement.

HS403 result:

- zKill candidate acquisition helper definitions now live under Discovery ownership in `src/main/discovery/zkillCandidateAcquisition.js`.
- Manual discovery imports zKill acquisition helpers from Discovery rather than Watch collector modules.
- Actor and system/radius collectors still run their current mixed collector orchestration and preserve current result shapes.
- Old collector helper export surfaces are retained only as compatibility aliases/imported exports.
- Provider path and write behavior are unchanged.

## HS401 Accepted Advisory

Accepted:

```txt
workspace/EngineeringTraceHS401-zkill-acquisition-helper-ownership.md
workspace/OverseerHS402-hs401-zkill-acquisition-helper-ownership-review.md
```

Accepted finding:

- actor/system zKill acquisition loops are Discovery-shaped in meaning but currently live in old Watch collector modules
- manual discovery imports those helper surfaces from old collector modules, proving the shared utility ownership smell
- move helper definitions into Discovery ownership before any runtime redirect or collector retirement

## HS399 Accepted Dev Runway
...
No `actor.watch` redirect, `runActorWatchService(...)` change, `watchExecutor.dispatchFor(...)` change, collector invocation/rewrite/retirement, zKill call, ESI call, provider-client movement, Discovery ref write behavior change, Evidence/EVEidence write behavior change, Hydration/metadata write, `fetch_runs` / API logs / warnings / Watch cadence behavior change, schema, Discovery task/packet persistence, dispatcher/queue/lease/worker behavior, command metadata/authority change, runtime enforcement, command blocking, UI, support artifact, source-term rename, or protected-word JSON update.

## HS399 Evidence

Implemented the Discovery-owned expansion queue helper extraction.

Added:

- `src/main/discovery/expansionQueueSelection.js`

Moved/re-homed helpers:
...
src/main/workers/systemRadiusCollector.js imports those helpers from:
  ../discovery/expansionQueueSelection

src/main/workers/actorWatchCollector.js imports those helpers from:
  ../discovery/expansionQueueSelection

src/main/workers/manualExpansionWorker.js imports those helpers from:
  ../discovery/expansionQueueSelection

src/main/workers/manualDiscoveryWorker.js imports summarizeExpansionQueue from:
  ../discovery/expansionQueueSelection
```

`systemRadiusCollector.js` still exports only its collector/discovery surfaces:
...
- helper definitions exist only in `src/main/discovery/expansionQueueSelection.js`
- current source callers use `../discovery/expansionQueueSelection`
- no source caller imports these helpers from `systemRadiusCollector.js`
...
- `git diff --check` returned exit code 0 with CRLF normalization warnings only
- `git status --short --branch` showed branch `main...origin/main [ahead 19]` with the existing broad unaccepted working set plus HS399-touched files
...
- Shared expansion queue selection helpers now live under Discovery ownership in `src/main/discovery/expansionQueueSelection.js`.
- Actor Watch, system/radius Watch, manual discovery, and manual expansion behavior remained unchanged under focused verification.
- This packet changed helper ownership only; runtime redirect, provider movement, collector retirement, schema, UI, enforcement, and durable task/packet work remain parked.

Recommended next action:

HS399 is accepted by `workspace/OverseerHS400-hs399-discovery-expansion-queue-helper-extraction-review.md`.
...
## HS397 Accepted Advisory

Accepted:

```txt
workspace/EngineeringTraceHS397-discovery-helper-ownership-source-trace.md
workspace/OverseerHS398-hs397-discovery-helper-ownership-source-trace-review.md
```

Accepted finding:

- low-level primitives remain reusable when owned correctly
- `collectActorWatch(...)` and `collectSystemRadiusWatch(...)` remain mixed legacy collector paths and are not future Discovery/Watch routes
- `selectExpansionCandidates(...)`, `markFailedExpansionCandidates(...)`, and `summarizeExpansionQueue(...)` are useful shared helpers but currently live in the wrong owner module
- the smallest useful next move is helper extraction into a Discovery-owned module with behavior preserved

## HS395 Accepted Dev Runway
...
Add an explicit no-provider actor Watch compatibility-wrapper preview command:

```txt
watch.actor_compatibility_wrapper.preview
```

The command should consume the old actor Watch payload shape, use already-proven boundary-owned fixture/adapter surfaces, return old caller-facing compatibility result shape, and prove no provider calls, writes, Watch mutation, collector invocation, schema, UI, or runtime enforcement.

Boundary:

Do not change `actor.watch`, `runActorWatchService(...)`, `collectActorWatch(...)`, `watchExecutor.dispatchFor(...)`, scheduled Watch task handling, system/radius Watch behavior, provider clients, schema, or renderer UI.
...
Implemented an explicit read-only actor Watch compatibility-wrapper preview command:
...
- consumes the old actor Watch payload shape (`entityType` / `entity_id`, `entityId` / `entity_id`, `entityName` / `entity_name`, `lookbackSeconds` / `lookback_seconds`, `maxRefs` / `max_refs`, `maxExpansions` / `max_expansions`)
- delegates to the accepted HS383 adapter fixture surface
- returns the old caller-facing compatibility result under `old_caller_facing_compatibility_result`
- exposes `represented_old_result_fields`, `approximate_old_result_fields`, `not_represented_old_result_fields`, and `parked_old_result_fields`
- marks old mixed/collector terminology as compatibility-only, not future doctrine
- discloses current runtime preservation:
  - `actor.watch` remains `runActorWatchService(...)`
  - `runActorWatchService(...)` remains `collectActorWatch(...)`
  - scheduled actor Watch dispatch remains `watchExecutor.dispatchFor(actor) -> actor.watch` with `collectActorWatch` runner
...
old caller-facing fields include:
  run_id
  actor
...
- all listed verification commands passed
- `npm.cmd run verify:service-registry` passed with a 300 second ceiling
- `npm.cmd run verify:enforcement-dry-run` reported coverage complete: 113 commands covered, 0 gaps, with `watch.actor_compatibility_wrapper.preview` classified as read-only non-enforcing proof
...
- `git diff --check` returned exit code 0 with CRLF normalization warnings only
- `git status --short --branch` showed branch `main...origin/main [ahead 19]` with the existing broad unaccepted working set plus HS395-touched files

Boundary confirmation:

- no zKill calls, ESI calls, live/API/provider movement, Discovery ref writes, Evidence/EVEidence writes, Hydration/metadata writes, Observation/report writes, Assessment writes, Watch cadence/state mutation, schema changes, `actor.watch` handler change, `runActorWatchService(...)` change, `collectActorWatch(...)` change, `watchExecutor.dispatchFor(...)` change, scheduled Watch task result changes, system/radius Watch behavior changes, mixed collector invocation/rewrite/retirement, dispatchers, queues, leases, workers, runtime enforcement activation, command blocking, renderer UI, support artifacts, source-term rename, or protected-word JSON update were added.
...
- Atlas now has an explicit no-provider/no-write compatibility-wrapper preview command for old actor Watch payloads.
- The preview exposes the old caller-facing result shape via the accepted HS383 adapter fixture, separates represented/approximate/not represented/parked old fields, and proves current runtime actor Watch paths remain unchanged.
- The command is registered as read-only, renderer eligible, classified in enforcement dry-run coverage, and included in command-authority, service-registry, and passive side-effect verification.

Recommended next action:

Overseer review HS395. If accepted, the next runway can decide whether to open a still-narrow default `actor.watch` compatibility-wrapper redirect proof, while keeping live providers, durable Discovery refs, Evidence/EVEidence writes, Watch cadence mutation, collector retirement, and scheduled redirect parked until explicitly authorized.

## HS393 Completed Advisory Request
...
Engineering/source trace should determine whether Atlas is ready for a first narrow `actor.watch` runtime redirect or compatibility-wrapper activation after the HS351-HS392 proof chain.
...
No implementation, runtime redirect, mixed collector invocation, zKill calls, ESI calls, Discovery ref writes, Evidence/EVEidence writes, Hydration, Watch cadence/state mutation, schema, runtime enforcement, renderer UI, source-term rename, or protected-word JSON update.

## HS391 Completed Dev Runway
...
The proof should show that one clean new ESI-expanded killmail can land normally while a separate duplicate/conflicting `killmail_id` in the same package preserves the existing raw killmail basis, emits repository conflict warning posture, and suppresses incoming conflict-derived dependent rows.

Boundary:

No zKill calls, ESI calls, live/API/provider movement, Discovery ref behavior, Watch cadence/run behavior, Hydration/metadata behavior, Observation/report output, Assessment writes, schema, `actor.watch` redirect, `runActorWatchService(...)` change, mixed collector invocation/rewrite/retirement, dispatchers, queues, leases, workers, runtime enforcement, renderer UI, support artifacts, source-term rename, protected-word JSON update, or raw ESI payload replacement.
...
Implemented the mixed clean-plus-conflict fixture proof for the Evidence/EVEidence writer landing package.
...
No production writer code changes were needed for HS391; the HS389 writer hardening already handled the mixed package.
...
- one clean new ESI-expanded killmail: `100138708`
- one separate duplicate/conflicting killmail: `100138707`
- original raw row for `100138707` is seeded before the mixed package
- the mixed package is built through `evidencePackageFromExpandedKillmails(...)`
- the mixed package is persisted through `EvidenceRepository.persistEvidencePackage(...)`
- controlled disposable `:memory:` fixture DB only

Sample mixed output from `verify:evidence-writer-landing-package-fixture`:
...
The clean killmail's raw row, activity rows, clean-backed entity rows, and audit land. The conflicting duplicate preserves the existing raw killmail row, emits the repository conflict warning, suppresses incoming conflict-derived activity rows/entities/audit, and does not replace the existing raw ESI payload.
...
- `npm.cmd run verify:protected-terms` completed with warning-only advisory output; no protected-word JSON updates or source-term renames were performed
- `git diff --check` returned exit code 0 with CRLF normalization warnings only
- `git status --short --branch` showed branch `main...origin/main [ahead 19]` with the existing broad HS356-HS391 working set plus HS391-touched files

Boundary confirmation:

- no zKill calls, ESI calls, live/API/provider movement, Discovery ref behavior, Watch cadence/run behavior, Hydration/metadata behavior, Observation/report output, Assessment writes, schema, `actor.watch` redirect, `runActorWatchService(...)` change, mixed collector invocation/rewrite/retirement, dispatchers, queues, leases, workers, runtime enforcement, renderer UI, support artifacts, source-term rename, protected-word JSON update, or raw ESI payload replacement were added
...
- Atlas now has a fixture-only proof that a single writer package can land a clean killmail while suppressing dependent rows for a separate conflicting duplicate killmail.
- The proof locks the mixed behavior into `verify:evidence-writer-landing-package-fixture` and the evidence rule regression manifest.
- HS391 required no additional production writer change.

Recommended next action:

Overseer review HS391. If accepted, the writer conflict assurance gap is closed enough to consider the next runtime adapter / redirect / collector-retirement proof, still without live/provider movement until explicitly opened.

## HS389 Completed Dev Runway
...
Harden the Evidence/EVEidence writer so duplicate/conflicting `killmail_id` input preserves the existing raw `killmails` row and conflict warning while suppressing incoming conflict-derived dependent rows.

Boundary:

No zKill calls, ESI calls, live/API/provider movement, Discovery ref behavior, Watch cadence/run behavior, Hydration/metadata behavior, Observation/report output, Assessment writes, schema, `actor.watch` redirect, `runActorWatchService(...)` change, mixed collector invocation/rewrite/retirement, dispatchers, queues, leases, workers, runtime enforcement, renderer UI, support artifacts, source-term rename, protected-word JSON update, raw ESI payload replacement, or hidden conflict warning.
...
Implemented Evidence/EVEidence writer conflict dependent-row hardening.
...
- duplicate/conflicting `killmail_id` input still preserves the existing `killmails` raw row, checksum/hash/time/system, and raw ESI payload
- conflict warning behavior is preserved through `KILLMAIL_PAYLOAD_CHECKSUM_MISMATCH`
- incoming conflicting `activity_events` are suppressed
- incoming conflict-only `entities` are suppressed unless supported by a non-conflicting landed event in the same package
- incoming conflicting `ingestion_audits` are suppressed so they do not imply the conflicting normalized rows became landed Evidence/EVEidence
- package-level normalizer warnings for conflicting killmail IDs are suppressed; repository conflict warnings remain visible
- same-payload rerun remains idempotent and still allows its normal audit trail
- clean payload landing, partial-but-usable payload landing, malformed pre-writer rejection, and malformed writer rollback remain unchanged

Sample hardened conflict output from `verify:evidence-writer-landing-package-fixture`:
...
- all listed verification commands passed
- `npm.cmd run verify:evidence-rules` initially failed because the newly added manifest phrase check did not match the actual verifier assertion text; the manifest phrase was corrected and the command passed on rerun
- `npm.cmd run verify:service-registry` passed with a 300 second ceiling
- `npm.cmd run verify:protected-terms` completed with warning-only advisory output; no protected-word JSON updates or source-term renames were performed
- `git diff --check` returned exit code 0 with CRLF normalization warnings only
- `git status --short --branch` showed branch `main...origin/main [ahead 19]` with the existing broad HS356-HS389 working set plus HS389-touched files

Boundary confirmation:

- no zKill calls, ESI calls, live/API/provider movement, Discovery ref behavior, Watch cadence/run behavior, Hydration/metadata behavior, Observation/report output, Assessment writes, schema, `actor.watch` redirect, `runActorWatchService(...)` change, mixed collector invocation/rewrite/retirement, dispatchers, queues, leases, workers, runtime enforcement, renderer UI, support artifacts, source-term rename, protected-word JSON update, raw ESI payload replacement, or hidden conflict warning were added
...
- Atlas now suppresses conflict-derived dependent Evidence/EVEidence rows when an incoming duplicate `killmail_id` conflicts with the stored raw killmail basis.
- The raw `killmails` row remains the durable Evidence/EVEidence basis, and conflict warning posture remains visible.
- The focused fixture proof now fails if conflicting incoming activity rows, conflict-only entity rows, or conflict audits land.

Recommended next action:

Overseer review HS389 and decide whether the next packet should proceed toward the runtime adapter/redirect seam or add one more writer-level mixed clean/conflict package proof before live/provider movement or collector retirement.

## HS387 Completed Dev Runway
...
Add a fixture-only Evidence/EVEidence writer landing package proof using controlled Discovery selected-ready candidate basis, injected expanded ESI killmail fixture payloads, `evidencePackageFromExpandedKillmails(...)` or the nearest no-provider package builder, and `EvidenceRepository.persistEvidencePackage(...)` against a controlled disposable fixture DB only.
...
No zKill calls, ESI calls, live/API/provider movement, operator corpus DB mutation, real Discovery ref mutation, Watch cadence/run mutation, Hydration/metadata writes, Observation/report output, Assessment writes, schema, `actor.watch` redirect, `runActorWatchService(...)` change, mixed collector invocation/rewrite/retirement, dispatchers, queues, leases, workers, runtime enforcement, renderer UI, support artifacts, source-term rename, protected-word JSON update, or production writer conflict-behavior patch unless a hard blocker makes the proof impossible and the handoff explains why.
...
Implemented the fixture-only Evidence/EVEidence writer landing package proof.
...
Duplicate/conflicting `killmail_id` output:

```txt
conflict_behavior_classification: existing_killmail_raw_row_preserved_but_conflicting_incoming_activity_events_inserted
killmailsWritten: 0
eventsWritten: 4
warning_classifications: KILLMAIL_PAYLOAD_CHECKSUM_MISMATCH
existing_raw_payload_preserved: true
...
This confirms the current writer preserves the existing raw `killmails` row while allowing conflicting incoming participant rows to land when their event keys differ. HS387 discloses this behavior and does not patch production writer conflict handling.

Malformed missing durable field output:
...
Unchanged tables / boundaries proven:

- `discovered_killmail_refs`: unchanged
- `api_request_logs`: unchanged
- Watch tables: unchanged
- Hydration/metadata tables: unchanged
- Assessment tables: unchanged
- `PRAGMA foreign_key_check`: ok / no rows
...
- no zKill calls, ESI calls, live/API/provider movement, operator corpus DB mutation, real Discovery ref mutation, Watch cadence/run mutation, Hydration/metadata writes, Observation/report output, Assessment writes, schema change, `actor.watch` redirect, `runActorWatchService(...)` change, mixed collector invocation/rewrite/retirement, dispatchers, queues, leases, workers, runtime enforcement, renderer UI, support artifacts, source-term rename, or protected-word JSON update were added
...
- Atlas now has a disposable fixture proof for the Evidence/EVEidence writer landing package boundary.
- The proof uses the current no-provider package builder and current repository writer against an internal fixture DB only.
- Clean landing, idempotency, local-cache skip posture, partial warning posture, malformed rollback/no-partial landing, and duplicate/conflicting behavior are all demonstrated.
- The main risk is now explicit: conflicting duplicate `killmail_id` input preserves the existing raw killmail row but can insert incoming conflicting activity rows.
...
- current durable writer landing point is `EvidenceRepository.persistEvidencePackage(...)`
- current no-provider package builder is `evidencePackageFromExpandedKillmails(...)`
- normalizer remains source of writer package rows
- writer proof should expose duplicate/conflicting `killmail_id` behavior before runtime replacement work
- next packet should be proof, not production hardening

## HS385 Source Trace Record
...
Run an advisory/source-trace pass on the Evidence/EVEidence writer landing package before any Dev implementation, runtime adapter, redirect, collector retirement, or live/provider movement.
...
Advisory/source trace only. Do not implement code, run provider calls, run live/API movement, mutate DB state, create schema, open a Dev runway, treat zKill candidate refs as Evidence/EVEidence, treat Hydration as Evidence/EVEidence creation, treat Observation/report output as writer landing, rename source-owned terms, or update protected-word JSON.

## HS383 Completed Dev Runway
...
Add a non-live, fixture-only actor Watch compatibility-wrapper adapter proof. The proof should construct an old caller-facing actor Watch result shape from injected boundary-owned fixture outputs while keeping `actor.watch` and all runtime paths unchanged.
...
Do not redirect `actor.watch`, change `runActorWatchService(...)`, change `watchExecutor.dispatchFor(...)`, invoke or retire `collectActorWatch(...)`, claim old collector return semantics are fully replaced without explicit mapping, call zKill, call ESI, perform live/API/provider movement, write Discovery refs, write Evidence/EVEidence, write Hydration/metadata, write API logs/warnings/`fetch_runs`/Watch run records/Watch cadence, mutate DB state, add schema, add tasks/queues/dispatchers/leases/workers, change system/radius behavior, change renderer UI, activate enforcement/command blocking, create support artifacts, rename source-owned terms, or update protected-word JSON.
...
Implemented the fixture-only/read-only actor Watch compatibility-wrapper adapter proof.
...
The new preview composes the accepted HS381 contract proof into an old caller-facing actor Watch result fixture with:

- `run_id`, `actor`, zKill ref count, duplicate/malformed removal count, dedupe count, cache-skip count, expansion attempt/cap/failure count, persisted killmail count, activity event count, API call count, warnings, collection plan, expansion queue, and expansion queue summary fields
- explicit old-result compatibility mapping for represented, approximate, not represented, and parked semantics
- fixture cases for refs found, no refs, malformed candidate, duplicate candidate, capped/not-selected candidate, provider deferral, local Evidence/EVEidence cache skip, retryable ESI-backed failure, and terminal ESI-backed failure
- table mutation snapshots before/after each preview
- boundary flags proving candidate refs remain possible leads, ESI-backed expansion remains Discovery-owned and not Hydration, Evidence/EVEidence writer is represented but not invoked, and Watch cadence is not mutated

Sample focused verifier output included:
...
Local Evidence/EVEidence cache skip fixture output included:
...
- all listed checks passed
- first `npm.cmd run verify:service-registry` attempt hit the 120 second tool timeout before result; rerun with a 300 second ceiling passed
...
- `runActorWatchService(...)` was not changed
...
- Atlas now has a fixture-only adapter proof that can construct an old caller-facing actor Watch result shape from boundary-owned fixture outputs.
- The adapter proof is distinguishable from the HS381 contract-only readout, a real runtime adapter, live provider execution, and Evidence/EVEidence landing.
- The command is registered as read-only/passive, covered by command authority, passive side-effect, service registry, and enforcement dry-run checks.
- Runtime redirect, collector retirement, live providers, durable Discovery refs, Evidence/EVEidence landing, Watch cadence mutation, and task/queue machinery remain parked.

Recommended next action:

Overseer review HS383 for acceptance, especially the old-result compatibility map and whether the represented/approximate/not-represented/parked categories are enough before opening any runtime redirect runway.

## HS383 Overseer Review
...
- HS383 is accepted as a non-live, fixture-only adapter proof.
- It constructs an old caller-facing actor Watch result fixture from boundary-owned fixture outputs.
- It does not redirect `actor.watch`, change `runActorWatchService(...)`, change `watchExecutor.dispatchFor(...)`, invoke or retire `collectActorWatch(...)`, call providers, write rows, add schema, activate enforcement, change UI, or create support artifacts.
- It preserves the accepted boundaries: candidate refs are possible leads, ESI-backed expansion is Discovery-owned and not Hydration, Evidence/EVEidence writer is final landed-memory boundary and not invoked, Watch cadence is not mutated.
...
Add a fixture-only, read-only actor Watch compatibility-wrapper contract proof before any runtime redirect or collector retirement.
...
Do not redirect `actor.watch`, change `runActorWatchService(...)`, change `watchExecutor.dispatchFor(...)` runtime behavior, invoke or retire `collectActorWatch(...)`, call zKill, call ESI, write Discovery refs, write Evidence/EVEidence, write Hydration/metadata, write `fetch_runs` / API logs / warnings / Watch run records, mutate Watch cadence, add schema, add tasks/queues/dispatchers/leases/workers, change system/radius behavior, change renderer UI, activate enforcement/command blocking, create support artifacts, rename source-owned terms, or update protected-word JSON.
...
Dev implemented the fixture-only, read-only actor Watch compatibility-wrapper contract proof command:

```txt
watch.actor_compatibility_wrapper_contract.preview
```

Focused verifier added:

```txt
verify:watch-actor-compatibility-wrapper-contract
```

The command composes the existing accepted proof surfaces:
...
- future boundary-owned stages for Watch intent/cadence, Discovery zKill candidate-lead acquisition, Discovery ESI-backed killmail/detail expansion intake, Evidence/EVEidence writer boundary, and Watch receipt/cadence placeholder
- candidate compatibility result shape for actor identity, lookback, max refs, max expansions, zKill target shape, candidate ref posture, selected ESI-backed intake candidates, local Evidence/EVEidence cache skip, retryable/terminal ESI-backed failure posture, Evidence/EVEidence writer not invoked, and Watch cadence not mutated
- legacy summary mapping separated into represented now, represented by existing fixture proof, not represented yet, and intentionally parked
- non-invocation proof and table mutation proof
...
- `watchExecutor.dispatchFor(...)` runtime behavior was not changed.
- `collectActorWatch(...)` was not invoked or retired.
- System/radius Watch behavior was untouched.
...
- Evidence/EVEidence writer remains final landed-memory boundary and was not invoked.
- No providers, zKill calls, ESI calls, live/API movement, Discovery ref writes, Evidence/EVEidence writes, Hydration/metadata writes, API logs/warnings, `fetch_runs`, Watch mutation, DB mutation, schema, tasks, queues, dispatchers, leases, workers, UI, enforcement, command blocking, support artifacts, source-term rename, or protected-word JSON update were added.
...
Final checks after handoff/current updates:
...
- `git status --short --branch` showed `main...origin/main [ahead 19]` with the expected existing uncommitted Discovery/Watch proof-chain working tree plus HS381 changes.
...
## HS381 Overseer Review

Accepted:

```txt
workspace/OverseerHS382-hs381-actor-watch-compatibility-wrapper-contract-review.md
```

Result:

- HS381 is accepted as a contract-only, inactive compatibility-wrapper proof.
- It does not redirect `actor.watch`, change `runActorWatchService(...)`, change `watchExecutor.dispatchFor(...)`, invoke or retire `collectActorWatch(...)`, call providers, write rows, add schema, activate enforcement, change UI, or create support artifacts.
- It proves the future wrapper contract shape and keeps runtime adapter, redirect, collector retirement, live providers, durable Discovery refs, Evidence/EVEidence landing, and Watch cadence mutation parked.
- No Dev runway is open.

Resting next options:

1. Non-live compatibility-wrapper adapter fixture that constructs the same result shape from injected boundary-owned fixtures while still not redirecting `actor.watch`.
...
Add a fixture-only, read-only Discovery ESI-backed expansion intake posture proof before actor Watch runtime replacement.
...
No providers, zKill calls, ESI calls, live/API movement, Discovery ref writes, Evidence/EVEidence writes, Hydration/metadata writes, API logs/warnings, `fetch_runs`, Watch mutation, DB mutation, schema, `actor.watch` redirect, `runActorWatchService` change, `watchExecutor.dispatchFor` change, collector invocation/retirement, tasks, queues, dispatchers, leases, workers, system/radius behavior change, UI, enforcement, command blocking, support artifacts, source-term rename, or protected-word JSON update is authorized.
...
Dev implemented the fixture-only, read-only Discovery ESI-backed expansion intake posture proof command:
...
The command composes the existing fixture handoff:
...
- HS379 accepted.
- `discovery.esi_expansion_intake_posture.preview` stays fixture-only, read-only, source-agnostic, and Discovery-owned.
- Candidate refs remain possible leads, not Evidence/EVEidence.
- ESI-backed killmail/detail expansion is not Hydration.
- Local Evidence/EVEidence cache skip is represented without creating a new write.
- Evidence/EVEidence writer boundary is represented but not invoked.
- Retryable and terminal ESI-backed failure postures are classification only.
- No providers, writes, schema, Watch mutation, runtime replacement, collector invocation/retirement, enforcement, UI, support artifacts, source-term rename, or protected-word JSON update were accepted.
...
Consider a narrow actor Watch compatibility-wrapper design/proof that routes `actor.watch` toward the boundary-owned path without live provider movement, durable Discovery ref writes, Evidence/EVEidence writes, or collector retirement in the same packet.

No active Dev runway is open.

## HS377 Active Dev Runway
...
Add an actor-only, fixture-only, read-only replacement parity proof command showing expected actor Watch behavior can be represented through the future boundary-owned route.
...
No `actor.watch` redirect, `runActorWatchService` runtime behavior change, `watchExecutor.dispatchFor` runtime behavior change, `collectActorWatch` invocation, provider calls, DB writes, Watch mutation, tasks, schema, UI, enforcement, command blocking, system/radius behavior change, protected-term update, or mixed collector retirement is authorized.
...
Dev implemented the actor-only, fixture-only, read-only replacement parity proof command:
...
- no `collectActorWatch`, `collectSystemRadiusWatch`, `WatchSessionExecutor.tick`, or `TaskRunner.runDetachedTask` invocation
- no live Watch dispatch, task creation, provider call, Discovery ref write, Evidence/EVEidence write, live/provider ESI-backed expansion, Hydration/metadata write, API log/warning write, `fetch_runs` write, Watch mutation, schema, queue/dispatcher/lease/worker/runtime provider work, system/radius behavior change, UI, enforcement, command blocking, source-term rename, protected-word JSON update, mixed collector redirect, or mixed collector retirement
...
Add a read-only/local-only route preview command showing how current actor Watch and system/radius Watch payload shapes map to the future boundary-owned replacement route.
...
No providers, live/API calls, mixed collector invocation, Watch execution, task creation, Watch mutation, Discovery ref writes, Evidence/EVEidence writes, live/provider ESI-backed expansion, Hydration/metadata writes, API logs/warnings, `fetch_runs` writes, durable Discovery task/packet/receipt schema, queue/dispatcher/lease, support artifacts, UI, runtime enforcement, command blocking, source-term rename, protected-word JSON update, mixed collector redirect, or mixed collector retirement is authorized.
...
Dev implemented the read-only/local-only route preview command:
...
- current command entry point shape: `actor.watch` / `system.radius.watch`
- current legacy collector that would have been used: `collectActorWatch` / `collectSystemRadiusWatch`
- future route stages with owner, input, output, and boundary
...
- no mixed collector invocation
- no Watch execution, task creation, or Watch mutation
...
- no queue, dispatcher, lease, support artifact, UI, enforcement, command blocking, source-term rename, or protected-word JSON update
...
- `verify:protected-terms` exited 0 with advisory warnings only; no renames and no protected-word JSON updates were performed.
- `git diff --check` exited 0 with line-ending warnings only.
- `git status --short --branch` reported `main...origin/main [ahead 19]` with existing uncommitted HS356/HS363/HS368/HS370 work preserved plus HS374 additions.
...
## HS372 Accepted Advisory Record

Opened:

```txt
workspace/OverseerHS372-mixed-watch-collector-replacement-planning-request.md
```

Accepted task:

Perform a source-trace and planning pass for staged replacement of legacy mixed Watch collector runtime paths.

Core posture:

- prefer correctness and cohesive boundary terminology over saving time through legacy reuse
- use `replacement` as the planning frame
- treat `redirect` as temporary compatibility only
- treat `retire` as the intended end-state
...
No implementation, file edits beyond the advisory artifact, provider calls, live Watch, task creation, Watch mutation, Discovery ref writes, Evidence/EVEidence writes, live/provider ESI-backed expansion, Hydration/metadata writes, schema, service registry changes, command authority changes, UI, or protected-word JSON updates are authorized.
...
```txt
workspace/OverseerHS370-discovery-acquisition-to-evidence-handoff-fixture-runway.md
```

Task:

Add a read-only/local-only fixture proof command showing Discovery receiving an acquisition request, producing provider-facing packet shapes, consuming fixture zKill-style outcomes, normalizing candidate refs, deriving a bounded receipt, and emitting ESI Evidence Expansion handoff candidates without writing Evidence/EVEidence.
...
No providers, live/API calls, mixed collector invocation, Watch execution, task creation, Watch mutation, Discovery ref writes, Evidence/EVEidence writes, real ESI Evidence Expansion, Hydration/metadata writes, API logs/warnings, `fetch_runs` writes, durable Discovery task/packet/receipt schema, queue/dispatcher/lease, support artifacts, UI, runtime enforcement, command blocking, source-term rename, protected-word JSON update, or mixed collector retirement/redirect is authorized.
...
Dev implemented the read-only/local-only fixture proof command:
...
- Discovery acquisition request in
- provider-facing fixture packet shapes
- fixture zKill-style packet outcomes
- normalized candidate refs with `killmail_id`, `killmail_hash`, packet/caller/source/provenance basis, and candidate system where available
- duplicate disclosure using `killmail_id` + `killmail_hash`
- canonical Discovery receipt basis and `watch_summary` projection carried through
- selected `esi_evidence_expansion_handoff_candidate` shapes
- not-selected candidate refs with explicit reasons
- request-level `held_by_external_io` before acquisition with no packet outcomes

Fixture cases covered:

- actor-style acquisition
- system/radius acquisition with multiple packets
- refs found
- no refs
...
- retryable failure
- terminal failure
- selected and not-selected Evidence Expansion handoff candidates

Mirror check represented these current mixed-collector responsibilities in Discovery fixture form:
...
- no Hydration/metadata writes
- no API logs, warnings, or `fetch_runs` writes
- no schema, queue, dispatcher, lease, support artifact, UI, enforcement, command blocking, source-term rename, protected-word JSON update, or mixed collector retirement/redirect
...
- `discovery.acquisition_to_evidence_handoff_fixture.preview` proves Discovery can carry the provider-facing acquisition utility shape up to ESI Evidence Expansion handoff candidates.
- The proof remains fixture-only and non-durable.
- Discovery receives acquisition requests, emits provider-facing packet shapes, normalizes candidate refs, discloses duplicate/not-selected posture, carries canonical receipt basis, and emits handoff-only Evidence Expansion candidates.
- Candidate refs remain possible leads, not durable Discovery refs and not Evidence/EVEidence.
- ESI Evidence Expansion handoff candidates are shapes only; no ESI call, Evidence/EVEidence write, or Evidence landing occurs.
- Mixed Watch collectors remain unretired and unredirected.

Resting next decision:

```txt
Decide whether the next seam is mixed Watch collector redirect/retirement planning, ESI Evidence Expansion intake ownership proof, or durable Discovery boundary doc/map consolidation.
```
...
- `verify:protected-terms` exited 0 with advisory warnings only; no renames and no protected-word JSON updates were performed.
- `git diff --check` exited 0 with line-ending warnings only.
- `git status --short --branch` reported `main...origin/main [ahead 19]` with existing uncommitted HS356/HS363/HS368 work preserved plus HS370 additions.
...
Overseer review HS370, especially the Evidence Expansion handoff candidate naming and duplicate/not-selected reason shape, then decide whether the next safe seam is mixed collector redirect planning or another fixture proof around Evidence Expansion intake ownership.

## HS363 Active Dev Runway
...
Add a read-only/local-only fixture proof command that consumes fixture Discovery pickup packets and fixture provider-return outcomes, then emits one canonical Discovery receipt basis and one requested safe projection.
...
- command emits a Discovery-owned canonical receipt basis plus one requested projection
- supported projections: `minimal`, `watch_summary`, `operator_detail`, `debug_basis`
- fixture cases cover actor and system/radius pickup packets, stored accepted system scope, refs found, no refs, partial deferred, provider deferred, acquisition capped, retryable failure, terminal failure, and request-level External I/O held posture
- attempted packet outcomes are limited to `complete_refs_found`, `complete_no_refs`, `partial_deferred`, `provider_deferred`, `acquisition_capped`, `failed_retryable`, and `failed_terminal`
- `held_by_external_io` is request-level only; the held fixture emits no packet outcomes and attempted/completed packet counts remain `0`
- candidate refs are projected as possible leads only, not durable Discovery refs, Evidence/EVEidence, Hydration, Observation, Assessment, or task memory
- service registry, command authority, passive side-effect, and enforcement dry-run coverage were updated for the new proof command
- no providers, live/API calls, Watch execution, Watch mutation, Discovery ref writes, Evidence/EVEidence writes, Hydration/metadata writes, API log/warning writes, schema, queue/dispatcher/lease, UI, support artifact, runtime enforcement, command blocking, source-term rename, or protected-word JSON update was added
...
- `verify:discovery-receipt-projection-fixture`: passed; printed canonical receipt plus `minimal`, `watch_summary`, `operator_detail`, and `debug_basis` samples
...
- `verify:protected-terms`: passed exit code `0`; warning-only advisory output, no renames or protected-word JSON updates
- `git diff --check`: passed with line-ending warnings only
- `git status --short --branch`: `## main...origin/main [ahead 19]` with HS363 edits plus pre-existing dirty/untracked workspace packet files
...
- review HS363 for acceptance
- keep durable Discovery receipt/task-packet schema parked until Overseer explicitly opens it
- next useful packet can either harden the receipt basis shape further or define the smallest future durable receipt seam without enabling provider movement
...
- `discovery.receipt_projection_fixture.preview` proves a fixture-only, non-durable Discovery receipt projection shape.
- The command emits a Discovery-owned canonical receipt basis plus one requested projection.
- Supported projections are `minimal`, `watch_summary`, `operator_detail`, and `debug_basis`.
- Candidate refs remain possible leads only, not durable Discovery refs, Evidence/EVEidence, Hydration, Observation, Assessment, or task memory.
- Attempted packet outcomes are limited to `complete_refs_found`, `complete_no_refs`, `partial_deferred`, `provider_deferred`, `acquisition_capped`, `failed_retryable`, and `failed_terminal`.
- `held_by_external_io` is request-level pre-acquisition posture only; it is not emitted as a packet outcome.
- No provider calls, DB writes, schema, Watch mutation, Evidence/EVEidence, Hydration, Observation, UI, dispatcher, support artifacts, runtime enforcement, or command blocking were opened.

Resting next decision:

```txt
Choose whether to sharpen the smallest durable Discovery receipt/task-packet seam, prove another non-durable runtime bridge, or pause Discovery and review Watch against the clearer Discovery utility boundary.
```

No Dev runway is open.

## HS365 Decision Surface
...
- HS363 proves the non-durable receipt projection shape can exist.
- The remaining uncertainty is how existing write-capable Watch/Discovery collector paths should be split before durable receipt/task-packet storage or live Watch movement.
- Preferred next lens is Engineering / Data Engineering source trace, not Dev implementation.
...
- existing code can be trimmed into the accepted model, but not by treating current mixed Watch collectors as the future boundary
- `collectActorWatch(...)` and `collectSystemRadiusWatch(...)` remain mixed paths combining Watch, Discovery, ESI Evidence Expansion, Evidence writes, warnings/logs, fetch-run lifecycle, and Watch run posture
- Discovery should own or face caller-agnostic acquisition intake, pickup packet fanout, zKill request shaping, provider attempt basis, candidate ref extraction/dedupe, acquisition outcome language, canonical receipt basis, and safe projections
- Watch should retain scheduling, cadence, accepted scope, and receipt interpretation
- durable Discovery task/packet/receipt schema remains parked
- live Watch provider movement remains parked

Next Dev runway opened:

```txt
workspace/OverseerHS368-watch-to-discovery-acquisition-split-fixture-bridge-runway.md
```

## HS368 Active Dev Runway
...
Add a read-only/local-only fixture proof command that proves current Watch dispatch payloads can feed a Discovery-owned acquisition boundary without entering the existing mixed Watch collector path.
...
No providers, live/API calls, mixed collector invocation, live Watch task dispatch, task creation, Watch mutation, Discovery ref writes, Evidence/EVEidence, ESI Evidence Expansion, Hydration, API logs/warnings, fetch-run writes, schema, queue/dispatcher/lease, support artifacts, UI, runtime enforcement, command blocking, source-term rename, or protected-word JSON update is authorized.
...
Dev implemented the read-only/local-only fixture bridge command:
...
- command proves current Watch dispatch payloads can be represented as a Discovery-owned acquisition request
...
- bridge emits `watch_summary` projection from the HS363 Discovery-owned canonical receipt basis
- fixture outcomes cover refs found, no refs, provider deferred, acquisition capped, retryable failure, and terminal failure
- request-level `held_by_external_io` is proven before acquisition with no packet outcomes emitted
- `dispatchFor(...)` compatibility is proven through the existing parity proof; dispatch runners are present but not invoked
- explicit non-invocation proof reports `collectActorWatch(...)`, `collectSystemRadiusWatch(...)`, `WatchSessionExecutor.tick(...)`, and `TaskRunner.runDetachedTask(...)` were not entered
- no providers, live/API calls, mixed collectors, Watch execution, tasks, Watch mutation, Discovery ref writes, Evidence/EVEidence writes, ESI Evidence Expansion, Hydration/metadata writes, API log/warning writes, `fetch_runs` writes, schema, queue/dispatcher/lease, support artifacts, UI, runtime enforcement, command blocking, source-term rename, or protected-word JSON update was added
...
- `watch.discovery_acquisition_split_fixture.preview` proves current Watch dispatch payloads can feed a Discovery-owned acquisition fixture boundary.
- Actor Watch bridges to one Discovery acquisition packet.
- System/radius Watch bridges to one packet per stored accepted `included_system_ids`.
- Stored accepted system IDs remain execution authority.
- Center/radius remain provenance/explanation and are not execution authority.
- Mixed collectors are explicitly not invoked.
- No providers, live/API calls, Watch execution, tasks, Watch mutation, Discovery ref writes, Evidence/EVEidence, ESI Evidence Expansion, Hydration, API log/warning writes, `fetch_runs`, schema, dispatcher/queue/lease, support artifacts, UI, runtime enforcement, or command blocking were opened.
...
- advisory/design packet for retiring or redirecting the mixed Watch collector path
- another no-live proof around the future Discovery acquisition utility boundary
- pause Discovery implementation and consolidate boundary docs
...
- review HS368 for acceptance
- keep real Watch executor redirection, provider movement, durable Discovery task/packet/receipt schema, and Watch schedule advancement parked until explicitly opened
- next useful seam is either another no-live split proof around the future Discovery acquisition utility boundary or a narrow redirect-design packet for retiring/bypassing the mixed collector path
...
- `discovery.outcome_derivation.preview` proves coarse Discovery outcome posture derivation from local rows.
- Task-level outcome candidates are derivable with confidence and missing-basis flags.
- Packet-level product-grade completion is explicitly not derivable from current rows.
- ESI Evidence Expansion context is surfaced only to prevent boundary confusion; it is not Discovery completion.
...
Next recommended shaping:

```txt
Discovery receipt / task-packet outcome model decision pass
```

No Dev runway is open.

## HS358 Discovery Receipt Shaping
...
- rich factual Discovery receipt is preferred
- Watch-specific completion language should not live inside Discovery
- product-grade per-packet completion still needs a receipt/task-packet basis
- no Dev runway is open
...
```txt
Should Atlas open a fixture-only, non-durable Discovery receipt proof?
```

Decision points before Dev:

- task and packet outcome vocabulary relation
- whether `held_by_external_io` belongs inside packet receipts now or remains gate posture
- minimum Watch needs for using receipt fields later
...
Next suitable Dev packet, if opened:

```txt
Discovery receipt projection fixture proof
```

Dev runway opened as `workspace/OverseerHS363-discovery-receipt-projection-fixture-proof-runway.md`.
...
```txt
show what Discovery outcome posture Atlas can derive today without provider calls, writes, task schema, or Watch posture mutation
```

Boundary:

Do not call providers, execute Watch, invoke dispatch runners/collectors, mutate Watch schedule/state, write Discovery refs, write Evidence/EVEidence, write Hydration/metadata labels, write API logs/warnings, create task/packet schema, create queues/dispatcher/leases, create support artifacts, change UI, activate enforcement, rename terms, or treat Discovery completion as Evidence/Hydration/Observation/Assessment completion.
...
Dev updated 2026-06-07:

- Added read-only renderer-eligible command `discovery.outcome_derivation.preview`.
- Added `buildDiscoveryOutcomeDerivationPreview(...)` in `src/main/services/discoveryOutcomeDerivationService.js`.
- Added `scripts/verify-discovery-outcome-derivation.js` and `npm.cmd run verify:discovery-outcome-derivation`.
- The proof derives coarse Discovery outcome posture only from existing local rows:
  - `fetch_runs`
  - `discovered_killmail_refs`
  - `api_request_logs`
  - `data_quality_warnings`
- The proof emits the accepted Discovery outcome vocabulary:
  - `complete_refs_found`
  - `complete_no_refs`
  - `partial_deferred`
  - `provider_deferred`
  ...
  - `failed_retryable`
  - `failed_terminal`
- The proof returns source intent kind, source ID/Watch ID/run ID, approximate scope key, task-level derived outcome candidate, task-level confidence, packet-level derivability summary, discovered ref count, sampled candidate ref handles, zKill API call count, ESI API call count as non-Discovery context, warning/error summary, missing-basis flags, and explicit boundary flags.
- Required fixture/local cases covered:
  ...
  - system/radius run with refs found derives coarse `complete_refs_found` at low confidence and flags missing per-packet completion rows.
  - zKill/provider deferred posture derives `provider_deferred` at low confidence and flags `provider_deferred_not_normalized`.
  - acquisition cap summary derives `acquisition_capped` and flags `cap_basis_summary_only`.
  - ESI expansion success/failure is surfaced only as context and flagged `esi_expansion_not_discovery_completion`.
  - no durable packet rows are reported via `packet_rows_present: false` and `product_grade_packet_outcomes_derivable: false`.
- The proof keeps `discovered_killmail_refs` as candidate-ref memory, not Discovery task/packet memory.
- The proof does not emit `invalid_scope` as a Discovery outcome.
- The proof separates ESI provider-capacity warnings from zKill/Discovery provider deferral so ESI expansion context cannot become Discovery completion.
- Mutation boundary proof reports unchanged durable Atlas table counts for every verifier case.
...
- Verification run:
  ...
  - `npm.cmd run verify:protected-terms` passed with warning-only advisory output: working-set scan covered 16 files and reported 844 warning-only items; no renames or protected-word JSON updates were performed.
  - `git diff --check` passed; only CRLF normalization warnings were emitted.
  - `git status --short --branch` showed branch `main...origin/main [ahead 19]` with HS356 working-tree changes plus existing uncommitted Overseer/audit runway files.
...
Status: Discovery outcome derivation proof complete and accepted by Overseer.
...
Normalize invalid stored System / Radius Watch scope handling across setup readout, authored execution readiness, and the readout/readiness bridge.
