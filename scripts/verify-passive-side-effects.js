...
async function verifySeededDb(root) {
  ...
  try {
    const passiveCalls = [
      ...
      ['watch.authored_execution_readiness.preview', () => invokeServiceCommand('watch.authored_execution_readiness.preview', {}, context)],
      ['watch.system_radius_setup_readout.preview', () => invokeServiceCommand('watch.system_radius_setup_readout.preview', {}, context)],
      ['watch.system_radius_readout_readiness_bridge.preview', () => invokeServiceCommand('watch.system_radius_readout_readiness_bridge.preview', {}, context)],
      ['watch.runtime_packet_plan.preview', () => invokeServiceCommand('watch.runtime_packet_plan.preview', {}, context)],
      ['watch.executor_tick_dry_run.preview', () => invokeServiceCommand('watch.executor_tick_dry_run.preview', {}, context)],
      ['watch.packet_dry_run_dispatch_parity.preview', () => invokeServiceCommand('watch.packet_dry_run_dispatch_parity.preview', {}, context)],
      ['watch.task_creation_boundary.preview', () => invokeServiceCommand('watch.task_creation_boundary.preview', {}, context)],
      ['watch.system_radius_run_stub.preview', () => invokeServiceCommand('watch.system_radius_run_stub.preview', {}, context)],
      ['watch.bucket_identity_projection.preview', () => invokeServiceCommand('watch.bucket_identity_projection.preview', {}, context)],
      ['watch.bucket_pickup_posture_bridge.preview', () => invokeServiceCommand('watch.bucket_pickup_posture_bridge.preview', {}, context)],
      ['watch.bucket_disposable_persistence_fixture.preview', () => invokeServiceCommand('watch.bucket_disposable_persistence_fixture.preview', {}, context)],
      ['watch.bucket_product_pickup_readout.preview', () => invokeServiceCommand('watch.bucket_product_pickup_readout.preview', {}, context)],
      ['watch.discovery_pickup_packet_proof.preview', () => invokeServiceCommand('watch.discovery_pickup_packet_proof.preview', {}, context)],
      ['discovery.pickup_consumer_fixture.preview', () => invokeServiceCommand('discovery.pickup_consumer_fixture.preview', {}, context)],
      ['discovery.pickup_consumer_hold_contract.preview', () => invokeServiceCommand('discovery.pickup_consumer_hold_contract.preview', {}, context)],
      ['discovery.pickup_selection_contract.preview', () => invokeServiceCommand('discovery.pickup_selection_contract.preview', {}, context)],
      ['discovery.provider_route_packet.preview', () => invokeServiceCommand('discovery.provider_route_packet.preview', {}, context)],
      ['discovery.pickup_execution_boundary.preview', () => invokeServiceCommand('discovery.pickup_execution_boundary.preview', {}, context)],
      ['discovery.dispatcher_lease_boundary.preview', () => invokeServiceCommand('discovery.dispatcher_lease_boundary.preview', {}, context)],
      ['discovery.candidate_ref_landing_boundary.preview', () => invokeServiceCommand('discovery.candidate_ref_landing_boundary.preview', {}, context)],
      ['discovery.settled_receipt_boundary.preview', () => invokeServiceCommand('discovery.settled_receipt_boundary.preview', {}, context)],
      ['discovery.outcome_derivation.preview', () => invokeServiceCommand('discovery.outcome_derivation.preview', {}, context)],
      ['discovery.receipt_projection_fixture.preview', () => invokeServiceCommand('discovery.receipt_projection_fixture.preview', {}, context)],
      ['watch.discovery_acquisition_split_fixture.preview', () => invokeServiceCommand('watch.discovery_acquisition_split_fixture.preview', {}, context)],
      ['discovery.acquisition_to_evidence_handoff_fixture.preview', () => invokeServiceCommand('discovery.acquisition_to_evidence_handoff_fixture.preview', {}, context)],
      ['discovery.esi_expansion_intake_posture.preview', () => invokeServiceCommand('discovery.esi_expansion_intake_posture.preview', {}, context)],
      ['evidence.writer_landing_package_fixture.preview', () => invokeServiceCommand('evidence.writer_landing_package_fixture.preview', {}, context)],
      ['watch.mixed_collector_replacement_route.preview', () => invokeServiceCommand('watch.mixed_collector_replacement_route.preview', {}, context)],
      ['watch.actor_replacement_parity.preview', () => invokeServiceCommand('watch.actor_replacement_parity.preview', {}, context)],
      ['watch.actor_compatibility_wrapper_contract.preview', () => invokeServiceCommand('watch.actor_compatibility_wrapper_contract.preview', {}, context)],
      ['watch.actor_compatibility_wrapper_adapter_fixture.preview', () => invokeServiceCommand('watch.actor_compatibility_wrapper_adapter_fixture.preview', {}, context)],
      ['watch.actor_compatibility_wrapper.preview', () => invokeServiceCommand('watch.actor_compatibility_wrapper.preview', {}, context)],
      ['watch.actor_discovery_route_body_fixture.preview', () => invokeServiceCommand('watch.actor_discovery_route_body_fixture.preview', {}, context)],
      ['watch.actor_discovery_handoff_contract.preview', () => invokeServiceCommand('watch.actor_discovery_handoff_contract.preview', {}, context)],
      ['watch.actor_controlled_runtime_adapter_fixture.preview', () => invokeServiceCommand('watch.actor_controlled_runtime_adapter_fixture.preview', {}, context)],
      ['watch.actor_controlled_adapter_disabled.preview', () => invokeServiceCommand('watch.actor_controlled_adapter_disabled.preview', {}, context)],
      ['watch.operator_confirmation_contract.preview', () => invokeServiceCommand('watch.operator_confirmation_contract.preview', {}, context)],
      ...
      ['watch.system_radius_acceptance_payload.preview', () => invokeServiceCommand('watch.system_radius_acceptance_payload.preview', {}, context)],
      ['watch.create_mutation_safety_map.preview', () => invokeServiceCommand('watch.create_mutation_safety_map.preview', {}, context)],
...
async function verifyEmptyDb(root) {
  ...
  try {
    const passiveCalls = [
      ...
      ['empty watch.authored_execution_readiness.preview', () => invokeServiceCommand('watch.authored_execution_readiness.preview', {}, context)],
      ['empty watch.system_radius_setup_readout.preview', () => invokeServiceCommand('watch.system_radius_setup_readout.preview', {}, context)],
      ['empty watch.system_radius_readout_readiness_bridge.preview', () => invokeServiceCommand('watch.system_radius_readout_readiness_bridge.preview', {}, context)],
      ['empty watch.runtime_packet_plan.preview', () => invokeServiceCommand('watch.runtime_packet_plan.preview', {}, context)],
      ['empty watch.executor_tick_dry_run.preview', () => invokeServiceCommand('watch.executor_tick_dry_run.preview', {}, context)],
      ['empty watch.packet_dry_run_dispatch_parity.preview', () => invokeServiceCommand('watch.packet_dry_run_dispatch_parity.preview', {}, context)],
      ['empty watch.task_creation_boundary.preview', () => invokeServiceCommand('watch.task_creation_boundary.preview', {}, context)],
      ['empty watch.system_radius_run_stub.preview', () => invokeServiceCommand('watch.system_radius_run_stub.preview', {}, context)],
      ['empty watch.bucket_identity_projection.preview', () => invokeServiceCommand('watch.bucket_identity_projection.preview', {}, context)],
      ['empty watch.bucket_pickup_posture_bridge.preview', () => invokeServiceCommand('watch.bucket_pickup_posture_bridge.preview', {}, context)],
      ['empty watch.bucket_disposable_persistence_fixture.preview', () => invokeServiceCommand('watch.bucket_disposable_persistence_fixture.preview', {}, context)],
      ['empty watch.bucket_product_pickup_readout.preview', () => invokeServiceCommand('watch.bucket_product_pickup_readout.preview', {}, context)],
      ['empty watch.discovery_pickup_packet_proof.preview', () => invokeServiceCommand('watch.discovery_pickup_packet_proof.preview', {}, context)],
      ['empty discovery.pickup_consumer_fixture.preview', () => invokeServiceCommand('discovery.pickup_consumer_fixture.preview', {}, context)],
      ['empty discovery.pickup_consumer_hold_contract.preview', () => invokeServiceCommand('discovery.pickup_consumer_hold_contract.preview', {}, context)],
      ['empty discovery.pickup_selection_contract.preview', () => invokeServiceCommand('discovery.pickup_selection_contract.preview', {}, context)],
      ['empty discovery.provider_route_packet.preview', () => invokeServiceCommand('discovery.provider_route_packet.preview', {}, context)],
      ['empty discovery.pickup_execution_boundary.preview', () => invokeServiceCommand('discovery.pickup_execution_boundary.preview', {}, context)],
      ['empty discovery.dispatcher_lease_boundary.preview', () => invokeServiceCommand('discovery.dispatcher_lease_boundary.preview', {}, context)],
      ['empty discovery.candidate_ref_landing_boundary.preview', () => invokeServiceCommand('discovery.candidate_ref_landing_boundary.preview', {}, context)],
      ['empty discovery.settled_receipt_boundary.preview', () => invokeServiceCommand('discovery.settled_receipt_boundary.preview', {}, context)],
      ['empty discovery.outcome_derivation.preview', () => invokeServiceCommand('discovery.outcome_derivation.preview', {}, context)],
      ['empty discovery.receipt_projection_fixture.preview', () => invokeServiceCommand('discovery.receipt_projection_fixture.preview', {}, context)],
      ['empty watch.discovery_acquisition_split_fixture.preview', () => invokeServiceCommand('watch.discovery_acquisition_split_fixture.preview', {}, context)],
      ['empty discovery.acquisition_to_evidence_handoff_fixture.preview', () => invokeServiceCommand('discovery.acquisition_to_evidence_handoff_fixture.preview', {}, context)],
      ['empty discovery.esi_expansion_intake_posture.preview', () => invokeServiceCommand('discovery.esi_expansion_intake_posture.preview', {}, context)],
      ['empty evidence.writer_landing_package_fixture.preview', () => invokeServiceCommand('evidence.writer_landing_package_fixture.preview', {}, context)],
      ['empty watch.mixed_collector_replacement_route.preview', () => invokeServiceCommand('watch.mixed_collector_replacement_route.preview', {}, context)],
      ['empty watch.actor_replacement_parity.preview', () => invokeServiceCommand('watch.actor_replacement_parity.preview', {}, context)],
      ['empty watch.actor_compatibility_wrapper_contract.preview', () => invokeServiceCommand('watch.actor_compatibility_wrapper_contract.preview', {}, context)],
      ['empty watch.actor_compatibility_wrapper_adapter_fixture.preview', () => invokeServiceCommand('watch.actor_compatibility_wrapper_adapter_fixture.preview', {}, context)],
      ['empty watch.actor_compatibility_wrapper.preview', () => invokeServiceCommand('watch.actor_compatibility_wrapper.preview', {}, context)],
      ['empty watch.actor_discovery_route_body_fixture.preview', () => invokeServiceCommand('watch.actor_discovery_route_body_fixture.preview', {}, context)],
      ['empty watch.actor_discovery_handoff_contract.preview', () => invokeServiceCommand('watch.actor_discovery_handoff_contract.preview', {}, context)],
      ['empty watch.actor_controlled_runtime_adapter_fixture.preview', () => invokeServiceCommand('watch.actor_controlled_runtime_adapter_fixture.preview', {}, context)],
      ['empty watch.actor_controlled_adapter_disabled.preview', () => invokeServiceCommand('watch.actor_controlled_adapter_disabled.preview', {}, context)],
      ['empty watch.operator_confirmation_contract.preview', () => invokeServiceCommand('watch.operator_confirmation_contract.preview', {}, context)],
      ...
      ['empty watch.system_radius_acceptance_payload.preview', () => invokeServiceCommand('watch.system_radius_acceptance_payload.preview', {}, context)],
      ['empty watch.create_mutation_safety_map.preview', () => invokeServiceCommand('watch.create_mutation_safety_map.preview', {}, context)],
